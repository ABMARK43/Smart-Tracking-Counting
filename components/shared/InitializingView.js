    ...
    return (
      <div className="initializing-view pt-20 pb-20 pr-12 pl-12">
        {!this.props.requestedFileRecording &&
          <h2 className="text-white text-3xl font-bold">Initializing Video Tracking</h2>
        }
        {this.props.requestedFileRecording &&
          <h2 className="text-white text-3xl font-bold">Restarting to begin recording data {this.props.fileName.split("/").pop()}</h2>
        }
